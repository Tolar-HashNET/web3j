...
public class WalletUtils {
    ...
    /**
     * Generates a BIP-39 compatible Tolar wallet. The private key for the wallet can be calculated
     ...
     * @return A BIP-39 compatible Tolar wallet
    ...
    /**
     * Generates a BIP-39 compatible Tolar wallet using a mnemonic passed as argument.
     *
     * @param password Will be used for both wallet encryption and passphrase for BIP-39 seed
